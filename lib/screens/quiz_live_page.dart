...
class _QuizLivePageState extends State<QuizLivePage>
  ...
  Participant get _participant => RoomService.instance
  ...
  void _answer(int index) {
    ...
    if (widget.room.phase == QuizPhase.leaderboard) {
      ...
      // Lanjut soal berikutnya setelah 800ms
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 10),
          Text('${widget.room.participants.length} peserta aktif',
              style: const TextStyle(
  ...
  Widget _buildAnsweredNote() {
    return Container(
      ...
      child: Row(children: [
        ...
        const Text('Jawaban tersimpan! Menunggu soal berikutnya...',
            style: TextStyle(
                fontSize: 13, color: _C.green, fontWeight: FontWeight.w600)),
      ]),
    );
  }
}
      ...
      child: AnimatedContainer(
        ...
        child: Row(children: [
          AnimatedContainer(
            ...
            child: Center(
                child: Text(_letters[index.clamp(0, 3)],
                    style: TextStyle(
                        fontSize: 13,
                        fontWeight: FontWeight.w800,
                        color: letterColor))),
